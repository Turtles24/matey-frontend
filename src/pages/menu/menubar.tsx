      ...
      <div className="z-100 relative flex h-screen items-center justify-center">
        <div className="flex items-center">
          <div className="text-[50px] font-bold">
            <div className="menu-icon mt-20 flex items-center">
              ...
              onClick={onClickImg}>
              <svg width="60" height="60" viewBox="0 0 24 24" fill="none" className=" hover:text-orange-500" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M13.8001 19.5514H19.8001M4.2002 19.5514L8.56618 18.6717C8.79796 18.625 9.01077 18.5109 9.17791 18.3437L18.9516 8.56461C19.4202 8.09576 19.4199 7.33577 18.9509 6.86731L16.8805 4.79923C16.4117 4.33097 15.6521 4.33129 15.1837 4.79995L5.40896 14.58C5.24214 14.7469 5.12824 14.9593 5.0815 15.1906L4.2002 19.5514Z" stroke-width="2" />
              </svg>
            ...
            <div className="menu-icon mt-6 flex items-center">
              <Button className="menu-icon ml-1 h-[50px] w-[80%] rounded-[20px] bg-transparent font-medium text-black hover:bg-orange-500 hover:font-bold hover:text-white">
              <svg width="15" height="15" viewBox="0 0 19 20" fill="none" className=" hover:text-orange-500" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.5 13.25V1.75M9.5 1.75L5 5.75M9.5 1.75L14 5.75" stroke-width="2" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M1 13.25V16.25C1 17.3546 1.89543 18.25 3 18.25H16C17.1046 18.25 18 17.3546 18 16.25V13.25" stroke-width="2" />
              </svg>
              <div className ="ml-2"></div>
                공유한 기록보기
              </Button>
            ...
            <div className="menu-icon mt-6 flex items-center">
              <Button className="menu-icon ml-1 h-[50px] w-[80%] rounded-[20px] bg-transparent font-medium text-black hover:bg-orange-500 hover:font-bold hover:text-white">
              <svg width="15" height="15" viewBox="0 0 19 20" fill="none" className=" hover:text-orange-500" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.5 1.75L9.5 13.25M9.5 13.25L14 9.25M9.5 13.25L5 9.25" stroke-width="2" /> 
                <path fill-rule="evenodd" clip-rule="evenodd" d="M1 13.25V16.25C1 17.3546 1.89543 18.25 3 18.25H16C17.1046 18.25 18 17.3546 18 16.25V13.25"stroke-width="2" />
              </svg>
              <div className ="ml-2"></div>
                공유받은 기록보기
            ...
            <div className="menu-icon mt-6 flex items-center">
              ...
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className=" hover:text-orange-500" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.3998 3.60041L9.9998 6.00041H13.9998L15.5998 3.60041M4.7998 4.80039V19.2004C4.7998 20.5259 5.87432 21.6004 7.1998 21.6004H16.7998C18.1253 21.6004 19.1998 20.5259 19.1998 19.2004V4.8004C19.1998 3.47492 18.1253 2.40041 16.7998 2.4004L7.19981 2.40039C5.87432 2.40039 4.7998 3.47491 4.7998 4.80039Z" stroke-width="2" />
                </svg>
                <div className ="ml-2"></div>
                SNS 홍보 이벤트
              </Button>
